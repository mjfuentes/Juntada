...
public class MessageService {
    ...
    public void sendMessage(final User user, final String messageString, final MessageType type, final Long typeId, final MessageSentListener listener){
        ...
        FirebaseAuth.getInstance().getCurrentUser().getIdToken(true).addOnCompleteListener(new OnCompleteListener<GetTokenResult>() {
            ...
            public void onComplete(@NonNull Task<GetTokenResult> task) {
                ...
                Call<Message> call = server.createMessage(headers, message);
    ...
    public void loadMessages(final Long eventId, final Long userId, final MessagesLoadedListener listener){
        FirebaseAuth.getInstance().getCurrentUser().getIdToken(true).addOnCompleteListener(new OnCompleteListener<GetTokenResult>() {
            ...
            public void onComplete(@NonNull Task<GetTokenResult> task) {
                ...
                Call<List<Message>> call = server.getMessages(headers, MessageType.EVENT.toString(), eventId);
